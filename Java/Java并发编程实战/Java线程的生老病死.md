...
要想整明白操作系统中线程的生命周期，就需要搞懂生命周期各个状态之间是如何转换的。

接下来先让我们了解下操作系统的线程生命周期，进而再去学习 Java 中线程的生命周期。

# 操作系统中线程的生命周期
操作系统的线程生命周期基本上可以用下图这个五态模型来描述。这五态分别是：初始状态、可运行状态、运行状态、休眠状态和终止状态。

![五态模型](https://img-blog.csdnimg.cn/20191126234311553.png)
...
![Java中的线程状态转换图](https://img-blog.csdnimg.cn/20191126235118923.png)
...
# 总结
本文介绍了操作系统中线程的生命周期，随后对 Java 中线程的生命周期进行介绍，并对各个状态间的转换进行讲解。

![](https://img-blog.csdnimg.cn/20191127000115972.png)